...
export default class Edit extends Component{
    ...
    componentDidMount(){
        Action.getTaskById(this.props.match.params.id)
            .then(response=>{
                this.setState({
    ...
    onSubmit = (e)=>{
        ...
        Action.updateTask(this.props.match.params.id,obj)
        //todo: change to other can navigate and refresh instead of history
                ...
                <div className="card-body mb-3">
                    <form onSubmit={this.onSubmit}>
                        ...
                        <div className="form-group row">
                            ...
                            <button type="submit" className="btn btn-primary mr-sm-3 mr-3">Update</button> 
